...
const AuthDialog = ({ open, onOpenChange }: AuthDialogProps) => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    loginFn({ email: formData.email, password: formData.password });
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-gradient-card border border-white/10 backdrop-blur-sm">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-muted-foreground">
            Sign in to save your virtual try-ons and access your gallery
          </DialogDescription>
        </DialogHeader>
